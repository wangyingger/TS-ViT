...
def get_args(with_deepspeed: bool = False):
    ...
    parser.add_argument("--c", default="/root/wangyingge/IELT-contrast/configs/cub.yaml",
                        type=str, help="config file path")

    ### about dataset
    parser.add_argument("--train_root", default="/root/wangyingge/datasets/CUB200-2011/train/",
                        type=str)  # "../NABirds/train/"
    parser.add_argument("--val_root", default="/root/wangyingge/datasets/CUB200-2011/test/", type=str)
    parser.add_argument("--data_size", default=448, type=int)
    parser.add_argument("--num_workers", default=0, type=int)
    parser.add_argument("--batch_size", default=64, type=int)

    ### model
    parser.add_argument("--model_name", default="vit", type=str, help='["resnet50", "swin-t", "vit", "efficient"]')
